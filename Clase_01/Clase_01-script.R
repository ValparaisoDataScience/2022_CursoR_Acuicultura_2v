...
# Tercero: Transforme nombre y empresa a factor usando el comando as.factor().
# Cuarto: Investuigue atributos de su objeto data.frame usando class(), summary().

# Trabajando con matrices.
# Simularemos y exploraremos abundancia de 3 especies de bacterias de la microbiota intestinal del salmón
# Estas bacterias se han asociado a la pigmentación del salmón.
# Simularemos como varían en el tiempo.
abundancia=c(1:21)
dim(abundancia)
